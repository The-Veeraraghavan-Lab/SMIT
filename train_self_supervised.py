...
def main():
    ...
    data_Root = os.path.normpath('/lila/data/deasy/Eric_Data/EVA_clinic_data/Extracted_all_data')

    json_Path = os.path.normpath('/lila/data/deasy/Eric_Data/Transformer_related/self_supervised_pretraining/thoracic_train/ssl_train.json')

    #json_Path = os.path.normpath('/lila/data/deasy/Eric_Data/Transformer_related/self_supervised_pretraining/json_files/btcv/dataset_0_init_24.json')
    #data_Root = os.path.normpath('/lila/data/deasy/Eric_Data/Transformer_related/UNETR/BTCV/dataset/dataset0')
    ...
    chunk_num=2
    batch_size = 6  # For the linear arrange, it would even go for bach_size of 6  #A100 max with batch of 12   # V100 can go batch_size 3 chunk_num 2
