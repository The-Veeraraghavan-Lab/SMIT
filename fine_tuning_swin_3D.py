...
parser.add_argument('--data_dir', default='/lila/data/deasy/Eric_Data/Transformer_related/UNETR/BTCV/dataset/dataset0/', type=str, help='dataset directory')
...
def main_worker(gpu, args):
    ...
    if 1:
        ...
        config = CONFIGS_TM['TransMorph-Small_Unetr'] # this one add the patch size from 4 to 2
        ...
        if args.resume_ckpt:
            ...
            pretrained_path = os.path.normpath('/lila/data/deasy/Eric_Data/Transformer_related/self_supervised_pretraining_github/Pre_trained/pre_train_weight.pt')  
